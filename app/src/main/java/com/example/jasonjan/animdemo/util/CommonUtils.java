package com.example.jasonjan.animdemo.util;
...
public class CommonUtils {
    ...
    public static int dp2px(float dpValue) {
        final float scale = DemoApp.getInstance().getResources().getDisplayMetrics().density;
    ...
    public static boolean isNetworkConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) DemoApp.getInstance().getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
